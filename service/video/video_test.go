...
func TestVideoHandlers_ExistAndStub(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		{method: http.MethodGet, path: "/api/v4/hls/1", body: "", status: http.StatusNotFound, code: serializer.CodeNotFound},
		{method: http.MethodDelete, path: "/api/v4/hls/1", body: "", status: http.StatusNotFound, code: serializer.CodeNotFound},
		{method: http.MethodGet, path: "/api/v4/hls/1/play/index.m3u8", body: "", status: http.StatusNotFound, code: serializer.CodeNotFound},
		{method: http.MethodGet, path: "/api/v4/hls/1/play/seg0.ts", body: "", status: http.StatusNotFound, code: serializer.CodeNotFound},
	} {
