...
- [x] Fill guidelines for assets
- [x] Add code examples
- [x] Include sibling `../frontend` conventions in frontend spec

---

## Spec files to populate

### Package: assets (`spec/assets/`)

- Frontend guidelines: `.trellis/spec/assets/frontend/`
